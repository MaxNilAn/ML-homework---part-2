...
# Числовые значения вместо гистограмм
...
# Задание легенды только для некоторых линий
# plt.legend(lines, ['1', 'второй', 'third', '4-ый'], loc='lower center')
...
# Пустые графики для создания легенды
...
# Создание экземпляра класса Legend
...
# Карты цветов
# 1 - последовательные (непрерываная последовательность нескольких цветов)
# 2 - дивергентые (два цвета)
# 3 - качественные (сложная палитра цветов)
