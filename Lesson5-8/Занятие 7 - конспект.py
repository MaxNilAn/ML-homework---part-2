...
# Определение сетки графиков (2 строки, 3 столбца)
...
# formatter - представление значений, locator - расстановка
...
# .matplotlibrc - файл для свойств по умолчанию