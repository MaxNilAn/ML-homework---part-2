...
print('x:\n', x)
print('\nРазбиение по внешнему массиву:\n', np.split(x, 2))
print('\nРазбиение по горизонтали (по второму индексу):\n', np.hsplit(x, 2))
print('\nРазбиение по вертикали (по первому индексу, как split):\n', np.vsplit(x, 2))
print('\nРазбиение по глубине (по третьему индексу):\n', np.dsplit(x, 2))
